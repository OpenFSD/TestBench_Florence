...
namespace Florence.Server_IO
{
    ...
    {
        [DllImport("ServerLibrary.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Unicode)]
    ...
    {
        [DllImport("ServerLibrary.dll", CallingConvention = CallingConvention.StdCall)]
